...
X_train,X_validation,Y_train,Y_validation = train_test_split(trainfeature,trainlabel,test_size=0.2,random_state=0)
...
print "get the test data part 1  ..."
testFeatureArray = np.load('./testfeaturepart1.npy')
dtest = xgb.DMatrix(testFeatureArray)
ypred = bst.predict(dtest)

UMLpairfile = '/home/wanghao/model/testpairpart1'
testUMLpair = []
...
print "get the test data part 2..."
testFeatureArray = np.load('./testfeaturepart2.npy')
dtest = xgb.DMatrix(testFeatureArray)
ypred = bst.predict(dtest)

filepair = '/home/wanghao/model/testpairpart2'
testUMLpair = []
...
print "get the test data part 3..."
testFeatureArray = np.load('./testfeaturepart3.npy')
dtest = xgb.DMatrix(testFeatureArray)
ypred = bst.predict(dtest)

filepair = '/home/wanghao/model/testpairpart3'
testUMLpair = []
with open(filepair, 'rb') as f:
    for line in f:
        line = line.strip('\r\n')
...
lrresultfile = '/home/wanghao/model/result/GBDTresult.csv'
