...
TrainFeature = np.load('./samplefeature1to5.npy')
TrainLabel = np.load('./samplelabel1to5.npy')
...
joblib.dump(LRmodel, './copymodel/lr_1to5/LRmodel.pkl')
...
resultfile = '/home/wanghao/newmodel/result/LRsample1to5result_prediction.csv'
