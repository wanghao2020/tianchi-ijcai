...
trainsetfile = '/home/wanghao/Document/tianchi/trainset/feturefrom7to10.pkl'
labelfile  =  '/home/wanghao/Document/tianchi/trainset/label.pkl'
X = []
label = []

rfile1 = open(trainsetfile, 'rb')
X = pickle.load(rfile1)
rfile2 = open(labelfile,'rb')
label = pickle.load(rfile2)
