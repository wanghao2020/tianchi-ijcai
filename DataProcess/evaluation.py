...
if __name__ == '__main__':
    ...
    evel = evaluation()
    truefile = '/home/wanghao/true'
    predictfile = '/home/wanghao/predict'
    merchantfile = '/home/wanghao/merchants'
    evel.getS_true(truefile)
    evel.getS_predict(predictfile)
    evel.get_MerchantBudget(merchantfile)

    for mer in evel.S_true.keys():
        print "merchantL",mer,'true pair',evel.S_true[mer]


    for mer in evel.S_predict.keys():
        print "merchant",mer,'predict pair',evel.S_predict[mer]
